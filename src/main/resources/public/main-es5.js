...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppTaskTaskComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    TaskComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 31,
      vars: 4,
      consts: [[1, "container"], [2, "color", "#3d0066"], [1, "form-group", "row"], [1, "col-xs-2"], ["type", "text", "id", "taskId", 1, "form-control", 2, "margin-left", "230px"], ["taskId", ""], ["type", "button", 1, "btn", "btn-primary", "btn-sm", 2, "margin-left", "250px", "margin-top", "10px", 3, "click"], [1, "table", 2, "color", "#30044d", "font-style", "oblique"]],
